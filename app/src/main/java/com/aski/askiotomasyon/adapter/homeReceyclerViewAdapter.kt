...
class homeReceyclerViewAdapter(context: Context, arizaliTesisAdlari:ArrayList<String?>, tumTesisMesafeleri:ArrayList<String?>):

    RecyclerView.Adapter<homeReceyclerViewAdapter.homeViewHolder>() {
